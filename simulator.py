...
def simulator(uv_path,gdth_path,measurement_path,super_resolution=1.5,img_size=(512,512),nufft_pkg='tkbn'):
    # Define u, v, w, y uv parameters from uv path
    uv = loadmat(uv_path, variable_names=["u", "v", "w", "frequency"])
